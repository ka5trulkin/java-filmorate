...
@Slf4j
public class FilmsInMemoryController {
    private final FilmDao<FilmInMemory> service;

    @Autowired
    public FilmsInMemoryController(@Qualifier("filmService") FilmDao<FilmInMemory> service) {
