...
public enum FilmSql {
    ...
    FILM_ADD_SQL("INSERT INTO FILM_DB (NAME, DESCRIPTION, RELEASE_DATE, DURATION) VALUES(?, ?, ?, ?)"),
    ...
    FILM_UPDATE_SQL("UPDATE FILM_DB SET NAME = ?, DESCRIPTION = ?, RELEASE_DATE = ?, DURATION = ? WHERE ID = ? "),
